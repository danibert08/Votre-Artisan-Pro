...
<body id="body" class="june">
    <div class="container">
        ...
        <header>
            ...
            <div id="accueil" class="en-tete">
                <div class="en-tete__hero">
                    <img class="en-tete__hero_hero-img" src="ypria/images/photos1/m13hero.jpeg" alt="" >
                </div>
                <div class="en-tete__logo">
                    <img class="en-tete__logo_logo-img" src="ypria/images/logo/logo.jpeg"  alt="">
                </div>
            </div>
            ...
            <section id="nails" class="services">
                ...
                <div  class="services__lambda">
                    ...
                    <p class="services__lambda_photos">
                        <img class="photo photo1" src="ypria/images/photos1/m1.jpeg" width="100" alt="">
                        <img class="photo photo2" src="ypria/images/photos1/m2.jpeg"  width="100" alt="">
                    </p>
                    <p class="services__lambda_photos">
                        <img class="photo photo3" src="ypria/images/photos1/m3.jpeg"  width="100" alt="">
                        <img class="photo photo4" src="ypria/images/photos1/m4.jpeg" width="100" alt="">
                    </p>
                    <p class="services__lambda_photos">
                        <img class="photo photo5" src="ypria/images/photos1/m5.jpeg" width="100" alt="">
                        <img class="photo photo6" src="ypria/images/photos1/m6.jpeg" width="100" alt="">
                    </p>
                    <p class="services__lambda_photos">
                        <img class="photo photo7" src="ypria/images/photos1/m7.jpeg"  width="100" alt="">
                        <img class="photo photo8" src="ypria/images/photos1/m8.jpeg"  width="100" alt="">
                    </p>
                    <p class="services__lambda_photos">
                        <img class="photo photo9" src="ypria/images/photos1/m9.jpeg"  width="100" alt="">
                        <img class="photo photo10" src="ypria/images/photos1/m10.jpeg" width="100" alt="">
                    </p>
                </div>
                <div class="en-tete__contact">
                ...
                <div class="services__lambda">
                    <h2  class="services__lambda_title">Maquillage</h2>
                        ...
                        <p class="services__lambda_photos">
                            <img class="photo photo11" src="ypria/images/photos2/mq1.jpeg" width="100" alt="">
                            <img class="photo photo12" src="ypria/images/photos2/mq2.jpeg"  width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo13" src="ypria/images/photos2/mq3.jpeg"  width="100" alt="">
                            <img class="photo photo14" src="ypria/images/photos2/mq4.jpeg" width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo15" src="ypria/images/photos2/mq5.jpeg" width="100" alt="">
                            <img class="photo photo16" src="ypria/images/photos2/mq6.jpeg" width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo17" src="ypria/images/photos2/mq7.jpeg"  width="100" alt="">
                            <img class="photo photo18" src="ypria/images/photos2/mq8.jpeg"  width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo19" src="ypria/images/photos2/mq9.jpeg"  width="100" alt="">
                            <img class="photo photo20" src="ypria/images/photos2/mq10.jpeg" width="100" alt="">
                        </p>                  
                </div>       
            </section>   
                <div class="en-tete__contact">
        ...
        <footer class="footer-nav">
            <a class="mentions-link" href="ypria/mentions.php">Mentions légales</a>
        </footer>
    </div>
</body>
</html>
