        ...
        <header>
            ...
            <div id="accueil" class="en-tete">
                <div class="en-tete__hero">
                    <img class="en-tete__hero_hero-img" src="images/photos1/m13hero.jpeg" alt="" >
                </div>
            ...
            <section id="nails" class="services">
                ...
                <div class="services__lambda">
                    <h2  class="services__lambda_title">Maquillage</h2>
                        ...
                        <p class="services__lambda_photos">
                            <img class="photo photo11" src="images/photos2/mq1.jpeg" width="100" alt="">
                            <img class="photo photo12" src="images/photos2/mq2.jpeg"  width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo13" src="images/photos2/mq3.jpeg"  width="100" alt="">
                            <img class="photo photo14" src="images/photos2/mq4.jpeg" width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo15" src="images/photos2/mq5.jpeg" width="100" alt="">
                            <img class="photo photo16" src="images/photos2/mq6.jpeg" width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo17" src="images/photos2/mq7.jpeg"  width="100" alt="">
                            <img class="photo photo18" src="images/photos2/mq8.jpeg"  width="100" alt="">
                        </p>
                        <p class="services__lambda_photos">
                            <img class="photo photo19" src="images/photos2/mq9.jpeg"  width="100" alt="">
                            <img class="photo photo20" src="images/photos2/mq10.jpeg" width="100" alt="">
                        </p>                  
                </div>       
            </section>   
                <div class="en-tete__contact">
                    <div class="button" >
                        <img class="en-tete__contact_icone" src="/pages_artisans/telephone.svg" alt=""> 
                        <a class="en-tete__contact-text" href="tel:+33745063458">             
                            07 45 06 34 58 
                        </a>
                    </div>
